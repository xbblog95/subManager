...
<head>
    ...
    <link href="${BASE_PATH}/static/css/animate.css" rel="stylesheet">
            ...
            <ul class="nav metismenu" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <img alt="image" class="rounded-circle" src="${BASE_PATH}/static/img/profile_smallest.png"/>
                        ...
                        <ul class="dropdown-menu animated fadeInRight m-t-xs">
                            <li><a class="dropdown-item" href="${BASE_PATH}user/toIndex">关于我</a></li>
                            <li><a class="dropdown-item modPass" href="javascript:void(0)" >修改密码</a></li>
                            <li class="dropdown-divider"></li>
                                <li><a class="dropdown-item" href="${BASE_PATH}user/loginOut">注销</a></li>
                        </ul>
                    </div>
                </li>
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                        <li class="active"><a href="${BASE_PATH}user/toIndex">个人中心</a></li>
                    </ul>
                </li>
            </ul>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        <div class="row border-bottom">
            <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                ...
                <ul class="nav navbar-top-links navbar-right">
                    ...
                    <li>
                        <a href="${BASE_PATH}user/loginOut">
        ...
        <div class="row  border-bottom white-bg dashboard-header">
            ...
            <div class="col-md-12">
                ...
                <a href="${BASE_PATH}/static/html/userguide/v2rayNg.html" target="_blank">点击此处查看v2rayNG使用教程</a>
                <br/>
                ...
                <a href="${BASE_PATH}/static/html/userguide/shadowsocksR.html" target="_blank" >点击此处查看shadowsocksR使用教程</a>
                <br/>
                ...
                <a href="${BASE_PATH}/static/html/userguide/shadowrocket.html" target="_blank">点击此处查看shadowrocket使用教程</a>
                <br/>
                ...
                <a href="${BASE_PATH}/static/html/userguide/quantumult.html" target="_blank">点击此处查看quantumult使用教程</a>
                <br/>
                ...
                <a href="${BASE_PATH}/static/html/userguide/clash.html" target="_blank">点击此处查看clash使用教程</a>
                <br/>
                ...
                <a href="${BASE_PATH}/static/html/userguide/potatso.html" target="_blank">点击此处查看Potatso Lite使用教程</a>
                <br/>
                ...
                <a href="${BASE_PATH}/static/html/userguide/pharosPro.html" target="_blank">点击此处查看Pharos Pro使用教程</a>
                <p style="color: red;font-size: 150%">各个客户端订阅格式不兼容，请选择对应正确的客户端订阅地址</p>
                <p>其他教程</p>
                <a href="${BASE_PATH}/static/html/userguide/switchyOmega.html" target="_blank">SwitchyOmega使用教程</a>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
...
<script src="${BASE_PATH}/static/js/plugins/metisMenu/metisMenu.js"></script>
<!-- Toastr -->
...
<script type="text/javascript" src="${BASE_PATH}/static/js/index/index.js"></script>
</body>
</html>
