...
public class StairSpeedTestMonitorNodeHandlerImpl implements MonitorNodeHandler {

    private static Logger logger = LoggerFactory.getLogger(StairSpeedTestMonitorNodeHandlerImpl.class);


    @Value("${node.monitor.websocket.url}")
    public String monitorWsUrl;

    @Value("${node.monitor.websocket.speedTestMode}")
    public String speedTestMode;
